...
(function(factory) {
    ...
    describe('Backbone.Schema', function() {
        ...
        var SchemaFactory = new BackboneSchema.Factory(),
            SchemaModel = BackboneSchema.Model,
            SchemaCollection = BackboneSchema.Collection,
            SchemaValueCollection = BackboneSchema.ValueCollection,
